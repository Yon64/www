function InitContext(paramsJSON)
{
	...
	{ 
		...
		if (container != null && typeof container === 'object')
		{
			...
			html += '<h1>Etoile d\'Or 2025</h1>';
			html += '<h2>'+tEvenement.GetCell('Organisateur', 0)+'</h2>';
			html += '<h3>Manche '+ski.GetCodeManche()+'</h3>';
	...
	myContext.getColumnsRanking = function()
	{
		...
		ranking.push({ name: "Categ", label: 'Cat.', "class": 'text-center', lg: 4});
		ranking.push({ name: "Sexe", label: 'S.', "class": 'text-center', lg: 2 });
		ranking.push({ name: "Equipe", label: 'E.S.F.', "class": 'text-start', lg: 25 });
